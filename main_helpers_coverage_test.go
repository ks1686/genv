...
func TestUpgradeJSON_DryRunAndEmptyPlan(t *testing.T) {
	...
	var code int
	out := captureStdout(t, func() {
		code = upgradeJSON(true, false, "", "", 0, f, lf, plan, nil, filters, extraUpgradeJSON{})
	})
	...
	out = captureStdout(t, func() {
		code = upgradeJSON(false, false, "", "", 0, f, lf, nil, nil, output.UpgradeFilters{HooksSkipped: true}, extraUpgradeJSON{})
	})
	if code != exitOK {
