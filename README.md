...
```bash
curl -Lo genv.tar.gz https://github.com/ks1686/genv/releases/latest/download/genv_4.5.0_linux_amd64.tar.gz
tar -xzf genv.tar.gz
...
```powershell
Invoke-WebRequest -Uri https://github.com/ks1686/genv/releases/latest/download/genv_4.5.0_windows_amd64.zip -OutFile genv.zip
