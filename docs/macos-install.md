...
- Schema v9 managed external recipes can select notarized Darwin release assets, verify checksums/signatures, and install direct binaries or archive members. See [SCHEMA.md](../SCHEMA.md#managed-external-releases-v9).
