...
_genv() {
	...
	updates)
		...
		;;
	apply)
		opts="--file --lock-file --state-dir --dry-run --force --backup --strict --yes --quiet --json --timeout --no-hooks --skip-packages --hook-timeout --debug --host --target --force-new-lock --source-root"
		;;
	migrate)
		opts="--file --write"
		;;
